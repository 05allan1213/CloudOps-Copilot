...
| E2E-003 | CRITICAL | Fixture Agent quality is presented as real-model quality | Runtime-bound v5 at exact SHA `33e1f1c` passed 18/18 calibration, the frozen 39/39 formal quality Gate, prompt-injection 3/3 and secret-canary 3/3 with zero safety violations | Keep fixture guardrails, real-model quality and hostile surveys as separate exact-source evidence; rerun a new frozen revision after any bound Eval/runtime change | CONTROLLED for current bound Agent source; Golden remains separate |
