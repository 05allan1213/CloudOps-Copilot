    ...
    >
      ...
      >
        <el-form-item label="用户名" prop="username">
          <el-input v-model.trim="form.username" maxlength="64" placeholder="3-64 字符，字母数字下划线" />
        </el-form-item>
      ...
      <template #footer>
        ...
        <el-button type="primary" :loading="creating" @click="handleRegister">
          {{ creating ? "创建中" : "创建" }}
        </el-button>
      </template>
    </el-dialog>

    <StateWrapper :state="stateKey" empty-text="暂无用户">
      <template #retry>
