...
import (
	...
	"github.com/05allan1213/CloudOps-Copilot/internal/compatibility/legacyschema"
	...
	appauth "github.com/05allan1213/CloudOps-Copilot/internal/service/auth"
...
func TestMySQLMigrationRepositoryAndConcurrentIngestion(t *testing.T) {
	...
	t.Run("legacy auto migration fixture", func(t *testing.T) {
		...
		const workers = 8
		if err := legacyDB.AutoMigrate(legacymodel.AllModels()...); err != nil {
