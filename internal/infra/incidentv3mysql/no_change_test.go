...
func TestDecideNoChangeWorkflowHonorsExternalWriteBoundary(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			state: noChangeWorkflowState{IncidentStatus: domain.V3StatusInvestigating,
		...
		},
		{
			...
			state: noChangeWorkflowState{IncidentStatus: domain.V3StatusAwaitingApproval,
		...
		},
		{
			...
			state: noChangeWorkflowState{IncidentStatus: domain.V3StatusDelivering,
		...
		},
		{
			...
			state:  noChangeWorkflowState{IncidentStatus: domain.V3StatusInvestigating, ActiveVerification: true},
			reason: "verification_already_active",
		},
		{
			name:   "verifying status",
			state:  noChangeWorkflowState{IncidentStatus: domain.V3StatusVerifying},
			reason: "verification_already_active",
		},
	}
