...
type V3MetricKind string

const (
	V3MetricErrorRate    V3MetricKind = "error_rate"
	V3MetricAvailability V3MetricKind = "availability"
	V3MetricReadiness    V3MetricKind = "readiness"
	V3MetricFiringAlerts V3MetricKind = "firing_alerts"
)

// V3MetricQuery contains only trusted dimensions and enum-selected templates.
// It deliberately has no PromQL field.
type V3MetricQuery struct {
	Kind         V3MetricKind
	Service      string
	Namespace    string
	Environment  string
...
// ObserveV3 executes the fixed Golden-demo Prometheus templates. Error-rate
...
func (p *Prometheus) ObserveV3(ctx context.Context, query V3MetricQuery) (verification.Observation, error) {
	if p == nil || p.c == nil {
	...
	case V3MetricErrorRate, V3MetricAvailability:
		...
		if query.Kind == V3MetricAvailability {
...
func (query V3MetricQuery) String() string {
