...
func TestStructuredModelRepairsDomainInvalidDeltaOnce(t *testing.T) {
	...
	model, calls := newStructuredTestModel(t, []string{invalid, valid})
...
func TestStructuredModelRepairsStructuredWindowParameter(t *testing.T) {
...
func TestStructuredModelRepairsUnsupportedDiagnosisCitation(t *testing.T) {
...
func TestStructuredModelFailsClosedAfterOneRepair(t *testing.T) {
	model, calls := newStructuredTestModel(t, []string{`{"unexpected":true}`, `{"unexpected":true}`})
...
func newStructuredTestModel(t *testing.T, outputs []string) (*LLMModel, func() int) {
	t.Helper()
