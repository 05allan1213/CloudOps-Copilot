...
import (
	...
	"github.com/05allan1213/CloudOps-Copilot/internal/incident"
...
type Service struct {
	*remediationapplication.Service
	cfg Config
}
...
func New(cfg Config) (*Service, error) {
	...
	application, err := remediationapplication.New(remediationapplication.Config{Enabled: cfg.Enabled, Repository: cfg.Repository, Now: cfg.Now})
	if err != nil {
		return nil, err
	}
