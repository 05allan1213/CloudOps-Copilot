...
func TestOpenAPITypedWorkbenchProjectionContracts(t *testing.T) {
	...
	wantResponses := map[string]string{
		"/api/v3/incidents/{id}/remediation-plans": "#/components/responses/RemediationPlanPage",
		"/api/v3/incidents/{id}/delivery":          "#/components/responses/DeliveryProjection",
		"/api/v3/incidents/{id}/verifications":     "#/components/responses/VerificationRunPage",
		"/api/v3/incidents/{id}/resolution-report": "#/components/responses/ResolutionReportProjection",
	}
	...
	for _, path := range []string{
		"/api/v3/incidents/{id}/remediation-plans",
		"/api/v3/incidents/{id}/delivery",
		"/api/v3/incidents/{id}/verifications",
		"/api/v3/incidents/{id}/resolution-report",
	} {
