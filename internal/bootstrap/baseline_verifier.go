...
func LoadBaselineVerifierConfig() (BaselineVerifierConfig, error) {
	...
	result := BaselineVerifierConfig{
		...
		Target: baseline.Target{
			...
			Namespace: configutil.String("V3_TARGET_NAMESPACE", "cloudops-demo"), WorkloadKind: "Deployment",
			WorkloadName: configutil.String("V3_TARGET_WORKLOAD", "cloudops-demo-workload"), ContainerName: configutil.String("V3_TARGET_CONTAINER", "cloudops-demo"),
		...
		Service:  configutil.String("V3_TARGET_SERVICE", "cloudops-demo-workload"),
