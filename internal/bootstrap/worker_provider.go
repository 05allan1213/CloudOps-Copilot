...
func LoadV3WorkerProviderConfig(application appconfig.Config) (V3WorkerProviderConfig, error) {
	...
	result := V3WorkerProviderConfig{
		...
		Target: V3WorkerTargetConfig{
			...
			Namespace: configutil.String("V3_TARGET_NAMESPACE", "cloudops-demo"), Service: configutil.String("V3_TARGET_SERVICE", "cloudops-demo-workload"),
			Workload: configutil.String("V3_TARGET_WORKLOAD", "cloudops-demo-workload"), Container: configutil.String("V3_TARGET_CONTAINER", "cloudops-demo"),
			...
			ReadyURL:       configutil.String("V3_TARGET_READY_URL", "http://demo-diagnostics.cloudops-demo.svc:8080/readyz"),
		...
		RequiredCheckName: configutil.String("V3_REQUIRED_CHECK_NAME", "cloudops/validate"), CheckProducerAppID: int64(configutil.NonNegativeInt("V3_REQUIRED_CHECK_APP_ID", 0)),
		WorkflowID: int64(configutil.NonNegativeInt("V3_REQUIRED_WORKFLOW_ID", 0)), WorkflowPath: configutil.String("V3_REQUIRED_WORKFLOW_PATH", ".github/workflows/cloudops-validate.yaml"),
