...
func validBaselineVerifierConfig() BaselineVerifierConfig {
	return BaselineVerifierConfig{
		Application: appconfig.Config{
			...
			K8SEnabled: true, K8SInCluster: true, K8SAllowedNamespaces: []string{"cloudops-demo"}, K8SRequestTimeout: 10 * time.Second,
		...
		Service: "cloudops-demo-workload", ArgoPath: "apps/demo", ArgoDestinationServer: "https://kubernetes.default.svc",
