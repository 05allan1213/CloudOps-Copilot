...
@media (max-width: 900px) { .revision-summary { align-items: stretch; flex-direction: column; } .revision-summary dl { width: 100%; min-width: 0; border-top: 1px solid var(--co-border-default); border-left: 0; } }
@media (max-width: 767px) { .settings-view { gap: var(--co-space-5); } .page-heading { align-items: flex-start; flex-direction: column; } .page-heading h1 { font-size: 25px; } .action-bar { align-items: stretch; flex-direction: column; } .action-bar > div { display: grid; grid-template-columns: repeat(3, minmax(0, 1fr)); } .action-bar button { min-width: 0; padding-inline: var(--co-space-2); font-size: 11px; } .form-grid, .form-grid--three, .form-grid--provider { grid-template-columns: 1fr; } .form-grid .span-two { grid-column: auto; } .provider-item > footer { align-items: stretch; flex-direction: column; } .provider-item > footer button { width: 100%; } .secret-editor { grid-template-columns: 1fr; } .secret-value { grid-column: auto; } .secret-references li { grid-template-columns: 1fr; } .validation-identity { grid-template-columns: 1fr; } .validation-providers { grid-template-columns: 1fr; } }
