...
.monitoring-query__promql-editor { display: block; box-sizing: border-box; width: 100%; min-width: 0; overflow: hidden; padding-inline: 16px; border: 1px solid var(--co-border-default); border-radius: var(--co-radius-frame); background: var(--co-bg-floating); transition: border-color 120ms ease; }
