...
export const appRoutes: RouteRecordRaw[] = [
  ...
  { path: "/monitoring", name: "monitoring", component: () => import("../views/monitoring/MonitoringView.vue"), meta: { title: "监控", workspace: "monitoring", provider: "prometheus", uiOwner: "nuxt-ui" } },
  { path: "/alerts", name: "alerts", component: () => import("../views/alerts/AlertsView.vue"), meta: { title: "告警", workspace: "alerts", provider: "alertmanager", uiOwner: "nuxt-ui" } },
  { path: "/alerts/:alertId", name: "alert-detail", component: () => import("../views/alerts/AlertDetailView.vue"), meta: { title: "告警详情", workspace: "alerts", provider: "alertmanager", hidden: true, uiOwner: "nuxt-ui" } },
  { path: "/logs", name: "logs", component: () => import("../views/logs/LogsView.vue"), meta: { title: "日志", workspace: "logs", provider: "elasticsearch", uiOwner: "nuxt-ui" } },
  { path: "/traces", name: "traces", component: () => import("../views/traces/TracesView.vue"), meta: { title: "链路", workspace: "traces", provider: "tempo", uiOwner: "nuxt-ui" } },
  { path: "/agent", name: "agent", component: () => import("../views/agent/AgentWorkspaceView.vue"), meta: { title: "Agent", workspace: "agent", provider: "llm", fullBleed: true, uiOwner: "nuxt-ui" } },
